  ...
  <div class="w-screen relative text-white text-sm font-light h-screen bg-black overflow-hidden">
    ...
    <transition name="staggered-fade">
      <router-link
        ...
        to="/play"
        class="absolute top-[53%] z-30 left-1/2 -translate-y-1/2 -translate-x-1/2 border border-white mx-auto block max-w-fit mt-8 rounded-full py-2 px-18 bg-transparent">
        Играть
      </router-link>
    </transition>
